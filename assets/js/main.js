...
function open_overview() {
  ...
  document.getElementById("tab_tb").classList.add("hover:text-gray-600", "hover:border-gray-300", "dark:hover:text-gray-300", "border-transparent");
...
function open_tb() {
  ...
  document.getElementById("tab_time").classList.add("hover:text-gray-600", "hover:border-gray-300", "dark:hover:text-gray-300", "border-transparent");
  document.getElementById("tab_time").classList.remove("active", "text-utd-green", "border-utd-green");
  document.getElementById("tab_tb").classList.remove("hover:text-gray-600", "hover:border-gray-300", "dark:hover:text-gray-300", "border-transparent");
